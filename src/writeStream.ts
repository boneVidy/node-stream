...
export type WriteStreamOptions<T> =T extends undefined? {}:T extends Object ? Options: string;
type Cache = {
    chunk: Buffer;
    encoding: string;
    callback: Function
...
export class WriteStream <T extends Object | string> extends EventEmitter {
    ...
    public write(chunk: string| Buffer | number, encoding = this.encoding, callback = () => {}){
